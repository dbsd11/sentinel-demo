...
public class DefaultLogger implements Debugger.Logger {
    ...
    public void d(String msg, Object... args) {
        if (Debugger.isEnableLog()) {
            Debugger.d(Debugger.LOG_TAG, format(msg, args));
        }
    }
    ...
    public void i(String msg, Object... args) {
        if (Debugger.isEnableLog()) {
            Debugger.i(Debugger.LOG_TAG, format(msg, args));
        }
    }
    ...
    public void w(String msg, Object... args) {
        if (Debugger.isEnableLog()) {
            Debugger.w(Debugger.LOG_TAG, format(msg, args));
        }
    }
    ...
    public void e(String msg, Object... args) {
        if (Debugger.isEnableLog()) {
            Debugger.e(Debugger.LOG_TAG, format(msg, args));
        }
    }
